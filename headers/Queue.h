...
public:
    ...
    void Retire(Node<T> *node, std::queue<Node<T> *> *node_queue) {
...
public:
    ...
    */
    explicit Queue(unsigned int NumOfThreads) {
    ...
    */
    void PairDeqFuturesWithResults(std::queue<T *> *deqList, Node<T> *oldHeadNode, unsigned int successfulDeqsNum,
                                   T *lastDeqItem,
