...
enum  Result_e {SUCCESS, ENQUEUE_FAIL, DEQUEUE_FAIL, FUTURE_ENQUEUE_FAIL, FUTURE_DEQUEUE_FAIL, EVALUATE_LIST_FAIL};
...
public:
  ...
  //      printQueue(queue4);
   ...
   //     printQueue(queue4);
    ...
    void printQueue(Queue<int>* queue5) {
